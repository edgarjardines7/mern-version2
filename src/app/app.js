...
class App extends Component {
    ...
    addTask(e){
        ...
        componentDidMount(){
            this.fetchTasks()
            console.log("El componenete fue montado")
        }
    fetchTasks(){
        fetch('/api/tasks')
        .then(res => res.json())
    ...
    editTask(id){
        ...
        .then(data => {
            ...
            this.setState({
                title:data.title,
                description:data.description,_id:data._id
    ...
    handleChange(e){
        const { name, value}=e.target; //desde e.target quiero solamente name y value
        this.setState({
            [name]:value
        })
            ...
            <div>
                ...
                <nav className="light-blue darken-4"> 
                    <div className="container">
                        <a className="brand-logo" href="/"> MERN Stacks</a>
                    </div>
                </nav>
